...
Docusaurus-based documentation for the ProductName solution, deployed as GitHub Pages at docs.CompanyName.com. Jira project: GPD.
...
`docs/service-operator/OPERATOR_OVERVIEW.md` is the canonical provisioning guide and the `service-operator` section entrypoint (`sidebar_position: 1`). It contains the ordered Hardware Setup and Software Installation step lists that operators follow to bring up a new ProductName cluster.
