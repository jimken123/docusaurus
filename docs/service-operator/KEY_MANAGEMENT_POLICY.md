...
Formal key management process for the ProductName platform.

## Scope

This policy applies to all cryptographic key material managed by the ProductName service operator role:
...
The **service operator** is the sole role authorized to perform key management operations on the ProductName platform. This includes key creation, distribution, rotation, revocation, destruction, and maintaining the [operations log](#audit-trail).
