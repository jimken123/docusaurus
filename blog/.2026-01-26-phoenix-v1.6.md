...
described below.
- Set up credentials for the private registry at ghcr.io/CompanyName. We will provide you with this token via secure means, and it will be required during the control plane installation process (more info ./service-operator/GHCR_AUTHENTICATION.md).
